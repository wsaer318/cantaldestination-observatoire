...
foreach ($apiFiles as $apiFile) {
    $searchPaths = [
        dirname(__DIR__) . '/legacy/blocks/' . $apiFile,
        dirname(__DIR__) . '/analytics/' . $apiFile,
        dirname(__DIR__) . '/filters/' . $apiFile,
        dirname(__DIR__) . '/' . $apiFile,
    ];
    ...
    if ($filepath === null) {
        $errors[] = "Fichier non trouve: $apiFile";
        continue;
    }
