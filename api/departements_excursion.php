<?php
/**
 * API Départements d'Excursion - Top 10 départements touristiques
 * Retourne le Top 10 des départements d'excursion pour les touristes
 */
...
try {
    ...
    // Exécution de la requête - Top 10 départements
    $sql = "
        SELECT nom_departement, total_visiteurs
        FROM (
            SELECT
                d.nom_departement,
    ...
    $response = [
        ...
        'total_departements' => count($results),
        'status' => 'success'
    ];
    ...
    header('Content-Type: application/json');
    echo json_encode([
        'error' => 'Erreur API départements excursion',
